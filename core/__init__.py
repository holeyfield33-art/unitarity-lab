# Holeyfield v1.3-certified — Hawking Flux Governor (Production)
# TMRP Session 18/19 Design Lock + DeepSeek + LoRA + Flux + Gemini Audit
...
from .flux import HawkingFluxGovernor, HAWKING_DECAY_RATE
